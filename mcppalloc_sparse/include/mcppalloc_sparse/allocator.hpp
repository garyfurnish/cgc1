...
#include <mcppalloc_utils/win32_slab.hpp>
      ...
      **/
      ...
      private:
        ...
        **/
        ...
        static_assert(::std::is_base_of<allocator_thread_policy_tag_t, typename allocator_policy_type::thread_policy_type>::value,
                      "");
        /**
