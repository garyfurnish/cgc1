#pragma once
#include <mcppalloc_sparse/declarations.hpp>
  ...
  namespace sparse
  {
    namespace details
    {
      ...
      struct os_size_compare {
        template <typename Allocator_Policy>
        inline auto operator()(const object_state_t<Allocator_Policy> *a, const object_state_t<Allocator_Policy> *b) const
            noexcept -> bool
        {
...
#ifdef MCPPALLOC_SPARSE_INLINES
