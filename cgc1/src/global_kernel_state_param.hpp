...
namespace cgc1
{
  ...
  private:
     ...
     */
    size_t m_slab_allocator_start_size = details::pow2(22);
    /**
     * \brief Expansion size of slab allocator.
     **/
    size_t m_slab_allocator_expansion_size = details::pow2(24);
    /**
     * \brief Size of packed allocator at start.
     **/
    size_t m_packed_allocator_start_size = details::pow2(26);
    /**
     * \brief Expansion size of packed allocator.
     **/
    size_t m_packed_allocator_expansion_size = details::pow2(28);
    /**
     * \brief Size of internal allocator at start.
     **/
    size_t m_internal_allocator_start_size = details::pow2(31);
    /**
     * \brief Expansion size of internal allocator.
     **/
    size_t m_internal_allocator_expansion_size = details::pow2(33);
  };
}
