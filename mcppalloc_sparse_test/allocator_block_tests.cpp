...
template <>
::mcppalloc::sparse::details::user_data_base_t mcppalloc::sparse::details::allocator_block_t<
    mcppalloc::sparse::default_allocator_policy_t<mcppalloc::aligned_allocator_t<void, 8ul>>>::s_default_user_data{};
void allocator_block_tests()
{
  describe("Block", []() {
    ...
    allocator_block_type block(memory, memory_size, 16, ::mcppalloc::sparse::c_infinite_length);
    void *alloc1 = nullptr;
    void *alloc2 = nullptr;
    void *alloc3 = nullptr;
    void *alloc4 = nullptr;
    ...
    it("fail massive alloc", []() {
      ...
      allocator_block_type block2(memory2, 96, 16, ::mcppalloc::sparse::c_infinite_length);
      AssertThat(block2.allocate(985), Equals(static_cast<void *>(nullptr)));
      free(memory2);
    });
    it("empty", []() {
      void *memory2 = malloc(1000);
      allocator_block_type block2(memory2, 992, 16, ::mcppalloc::sparse::c_infinite_length);
